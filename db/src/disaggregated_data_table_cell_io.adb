--
-- Created by ada_generator.py on 2012-07-24 19:03:55.792486
-- 
with Wsc_Db_Data;
...
package body Disaggregated_Data_Table_Cell_IO is
   ...
   function Retrieve( sqlstr : String ) return Wsc_Db_Data.Disaggregated_Data_Table_Cell_List.Vector is
      ...
      Value1_len : aliased SQLINTEGER := Value1'Size/8;
      Value2_len : aliased SQLINTEGER := Value2'Size/8;
      Value3_len : aliased SQLINTEGER := Value3'Size/8;
      Value4_len : aliased SQLINTEGER := Value4'Size/8;
      Value5_len : aliased SQLINTEGER := Value5'Size/8;
      Value6_len : aliased SQLINTEGER := Value6'Size/8;
      I_len : aliased SQLINTEGER := I'Size/8;
      P1_len : aliased SQLINTEGER := P1'Size/8;
      P2_len : aliased SQLINTEGER := P2'Size/8;
      P3_len : aliased SQLINTEGER := P3'Size/8;
      Disaggregated_Data_Table_Cell : Wsc_Db_Data.Disaggregated_Data_Table_Cell;
   begin
   ...
   -- otherwise throws DB_Exception exception. 
   --
   procedure Save( Disaggregated_Data_Table_Cell : Wsc_Db_Data.Disaggregated_Data_Table_Cell; overwrite : Boolean := True ) is   
      ps : sql.SQLHDBC := sql.SQL_NULL_HANDLE;
