--
-- Created by ada_generator.py on 2012-07-24 19:03:55.720391
-- 
with Wsc_Db_Data;
...
package body Probit_Threshold_IO is
   ...
   --
   function Retrieve_By_PK( Username : Unbounded_String; Run_Id : integer; Element : probit_threshold_element_Enum ) return Wsc_Db_Data.Probit_Threshold is
   ...
   function Retrieve( sqlstr : String ) return Wsc_Db_Data.Probit_Threshold_List.Vector is
      ...
      Threshold_len : aliased SQLINTEGER := Threshold'Size/8;
      Probit_Threshold : Wsc_Db_Data.Probit_Threshold;
   begin
      ...
      begin -- exception block
         ...
         loop
            ...
            Probit_Threshold.Element := probit_threshold_element_Enum'Val( Element );
   ...
   procedure Add_Element( c : in out d.Criteria; Element : probit_threshold_element_Enum; op : d.operation_type:= d.eq; join : d.join_type := d.join_and ) is   
   elem : d.Criterion := d.make_Criterion_Element( "element", op, join, Integer( probit_threshold_element_Enum'Pos( Element )) );
   begin
      d.add_to_criteria( c, elem );
   end Add_Element;
