--
-- Created by ada_generator.py on 2012-07-24 19:03:55.721050
-- 
with Wsc_Db_Data;
with DB_Commons;
with Base_Types;
...
package Personal_Results_IO is
   ...
   procedure Add_Passes_Non_Residential_Capital_Test( c : in out d.Criteria; Passes_Non_Residential_Capital_Test : personal_results_passes_non_residential_capital_test_Enum; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
   procedure Add_Passes_Non_Residential_Income_Test( c : in out d.Criteria; Passes_Non_Residential_Income_Test : personal_results_passes_non_residential_income_test_Enum; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
   procedure Add_Passes_Residential_Capital_Test( c : in out d.Criteria; Passes_Residential_Capital_Test : personal_results_passes_residential_capital_test_Enum; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
   procedure Add_Passes_Residential_Income_Test( c : in out d.Criteria; Passes_Residential_Income_Test : personal_results_passes_residential_income_test_Enum; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
   procedure Add_Passes_Residential_Means_Test( c : in out d.Criteria; Passes_Residential_Means_Test : personal_results_passes_residential_means_test_Enum; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
   procedure Add_Passes_Non_Residential_Means_Test( c : in out d.Criteria; Passes_Non_Residential_Means_Test : personal_results_passes_non_residential_means_test_Enum; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
   ...
   procedure Add_Uap( c : in out d.Criteria; Uap : personal_results_uap_Enum; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
   procedure Add_Remaining_Capital_Stock( c : in out d.Criteria; Remaining_Capital_Stock : Amount; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
   --
   ...
   procedure Add_Remaining_Capital_Stock_To_Orderings( c : in out d.Criteria; direction : d.Asc_Or_Desc );
