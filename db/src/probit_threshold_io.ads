--
-- Created by ada_generator.py on 2012-07-24 19:03:55.716287
-- 
with Wsc_Db_Data;
with DB_Commons;
with Base_Types;
...
package Probit_Threshold_IO is
   ...
   --
   function Retrieve_By_PK( Username : Unbounded_String; Run_Id : integer; Element : probit_threshold_element_Enum ) return Wsc_Db_Data.Probit_Threshold;
   ...
   procedure Add_Element( c : in out d.Criteria; Element : probit_threshold_element_Enum; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
