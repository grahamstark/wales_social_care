--
-- Created by ada_generator.py on 2012-07-24 19:03:55.774725
-- 
with Wsc_Db_Data;
...
package body Disaggregated_Data_Table_Cell_Description_IO is
   ...
   function Retrieve( sqlstr : String ) return Wsc_Db_Data.Disaggregated_Data_Table_Cell_Description_List.Vector is
      ...
      Cell_Pos_len : aliased SQLINTEGER := Cell_Pos'Size/8;
      Cell_Label_len : aliased SQLINTEGER := Cell_Label'Size/8;
      Cell_Type_len : aliased SQLINTEGER := Cell_Type'Size/8;
      File_Pos_len : aliased SQLINTEGER := File_Pos'Size/8;
      Disaggregated_Data_Table_Cell_Description : Wsc_Db_Data.Disaggregated_Data_Table_Cell_Description;
   begin
