--
-- Created by ada_generator.py on 2012-07-24 19:03:55.846600
-- 
with Wsc_Db_Data;
...
package body Table_Stats_IO is
   ...
   function Retrieve( sqlstr : String ) return Wsc_Db_Data.Table_Stats_List.Vector is
      ...
      Row_Num_len : aliased SQLINTEGER := Row_Num'Size/8;
      Col_Num_len : aliased SQLINTEGER := Col_Num'Size/8;
      Wave_len : aliased SQLINTEGER := Wave'Size/8;
      System_Number_len : aliased SQLINTEGER := System_Number'Size/8;
      Nvalues_len : aliased SQLINTEGER := Nvalues'Size/8;
      Rmean_1_len : aliased SQLINTEGER := Rmean_1'Size/8;
      Rmin_1_len : aliased SQLINTEGER := Rmin_1'Size/8;
      Rmax_1_len : aliased SQLINTEGER := Rmax_1'Size/8;
      Rmed_1_len : aliased SQLINTEGER := Rmed_1'Size/8;
      Sddev_1_len : aliased SQLINTEGER := Sddev_1'Size/8;
      Dec1_1_len : aliased SQLINTEGER := Dec1_1'Size/8;
      Dec10_1_len : aliased SQLINTEGER := Dec10_1'Size/8;
      Rmean_2_len : aliased SQLINTEGER := Rmean_2'Size/8;
      Rmin_2_len : aliased SQLINTEGER := Rmin_2'Size/8;
      Rmax_2_len : aliased SQLINTEGER := Rmax_2'Size/8;
      Rmed_2_len : aliased SQLINTEGER := Rmed_2'Size/8;
      Sddev_2_len : aliased SQLINTEGER := Sddev_2'Size/8;
      Dec1_2_len : aliased SQLINTEGER := Dec1_2'Size/8;
      Dec10_2_len : aliased SQLINTEGER := Dec10_2'Size/8;
      Rmean_3_len : aliased SQLINTEGER := Rmean_3'Size/8;
      Rmin_3_len : aliased SQLINTEGER := Rmin_3'Size/8;
      Rmax_3_len : aliased SQLINTEGER := Rmax_3'Size/8;
      Rmed_3_len : aliased SQLINTEGER := Rmed_3'Size/8;
      Sddev_3_len : aliased SQLINTEGER := Sddev_3'Size/8;
      Dec1_3_len : aliased SQLINTEGER := Dec1_3'Size/8;
      Dec10_3_len : aliased SQLINTEGER := Dec10_3'Size/8;
      Rmean_4_len : aliased SQLINTEGER := Rmean_4'Size/8;
      Rmin_4_len : aliased SQLINTEGER := Rmin_4'Size/8;
      Rmax_4_len : aliased SQLINTEGER := Rmax_4'Size/8;
      Rmed_4_len : aliased SQLINTEGER := Rmed_4'Size/8;
      Sddev_4_len : aliased SQLINTEGER := Sddev_4'Size/8;
      Dec1_4_len : aliased SQLINTEGER := Dec1_4'Size/8;
      Dec10_4_len : aliased SQLINTEGER := Dec10_4'Size/8;
      Rmean_5_len : aliased SQLINTEGER := Rmean_5'Size/8;
      Rmin_5_len : aliased SQLINTEGER := Rmin_5'Size/8;
      Rmax_5_len : aliased SQLINTEGER := Rmax_5'Size/8;
      Rmed_5_len : aliased SQLINTEGER := Rmed_5'Size/8;
      Sddev_5_len : aliased SQLINTEGER := Sddev_5'Size/8;
      Dec1_5_len : aliased SQLINTEGER := Dec1_5'Size/8;
      Dec10_5_len : aliased SQLINTEGER := Dec10_5'Size/8;
      Rmean_6_len : aliased SQLINTEGER := Rmean_6'Size/8;
      Rmin_6_len : aliased SQLINTEGER := Rmin_6'Size/8;
      Rmax_6_len : aliased SQLINTEGER := Rmax_6'Size/8;
      Rmed_6_len : aliased SQLINTEGER := Rmed_6'Size/8;
      Sddev_6_len : aliased SQLINTEGER := Sddev_6'Size/8;
      Dec1_6_len : aliased SQLINTEGER := Dec1_6'Size/8;
      Dec10_6_len : aliased SQLINTEGER := Dec10_6'Size/8;
      Table_Stats : Wsc_Db_Data.Table_Stats;
   begin
