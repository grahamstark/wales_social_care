...
package body Model.WSC.BHPS_Data_Creation_Libs is
   ...
   procedure Create_Incomes( ad : BHPS.Adult; mad : in out wscm.Person ) is
      ...
      function Make_Current( inc : Income_Rec ) return Amount is
         a : Amount;
      begin
         ...
         Log( "Make_Current; frval" & inc.frval'Img & " frw " & inc.frw'Img );
         return a;
      end Make_Current;
  ...
  -- gross_wage,
      ...
      if ad.indresp.paynw <= 0.0 or ad.indresp.paynl <= 0.0 then
          mad.current_income( WSC_Enums.net_wage ) := mad.current_income( WSC_Enums.gross_wage );
      else
         mad.current_income( WSC_Enums.net_wage ) :=  ad.indresp.paynl / ad.indresp.paynw;
      end if;
      ...
      for i in 1 .. ad.num_incomes loop
         ...
         a := Make_Current( ad.incomes( i )); 
         case ad.incomes( i ).ficode is
            when BHPS_Enums.ni_retir_pension => 
               mad.current_income( WSC_Enums.ni_retir_pension ) := a;
               -- mad.annual_income( WSC_Enums.ni_retir_pension ) := a( 2 );
            when BHPS_Enums.sev_disabl_allow => 
               mad.current_income( WSC_Enums.sev_disabl_allow ) := a;
               -- mad.annual_income( WSC_Enums.sev_disabl_allow ) := a( 2 );
            when BHPS_Enums.invalidity_pens => 
               mad.current_income( WSC_Enums.invalidity_pens ) := a;
               -- mad.annual_income( WSC_Enums.invalidity_pens ) := a( 2 );
            when BHPS_Enums.ind_injury_allow => mad.current_income( WSC_Enums.ind_injury_allow ) := a; -- mad.annual_income( WSC_Enums.ind_injury_allow ) := a( 2 );
            when BHPS_Enums.attendance_allow => mad.current_income( WSC_Enums.attendance_allow ) := a; -- mad.annual_income( WSC_Enums.attendance_allow ) := a( 2 );
            when BHPS_Enums.pension_prev_emp => mad.current_income( WSC_Enums.pension_prev_emp ) := a; -- mad.annual_income( WSC_Enums.pension_prev_emp ) := a( 2 );
            when BHPS_Enums.mobility_allow => mad.current_income( WSC_Enums.mobility_allow ) := a; -- mad.annual_income( WSC_Enums.mobility_allow ) := a( 2 );
            when BHPS_Enums.inv_care_allow => mad.current_income( WSC_Enums.inv_care_allow ) := a; -- mad.annual_income( WSC_Enums.inv_care_allow ) := a( 2 );
            when BHPS_Enums.war_disabl_pens => mad.current_income( WSC_Enums.war_disabl_pens ) := a; -- mad.annual_income( WSC_Enums.war_disabl_pens ) := a( 2 );
            when BHPS_Enums.disab_livng_allwnce => mad.current_income( WSC_Enums.disab_livng_allwnce ) := a; -- mad.annual_income( WSC_Enums.disab_livng_allwnce ) := a( 2 );
            when BHPS_Enums.disab_wrkng_allwnce => mad.current_income( WSC_Enums.disab_wrkng_allwnce ) := a; -- mad.annual_income( WSC_Enums.disab_wrkng_allwnce ) := a( 2 );
            when BHPS_Enums.incapacity_benefit => mad.current_income( WSC_Enums.incapacity_benefit ) := a; -- mad.annual_income( WSC_Enums.incapacity_benefit ) := a( 2 );
            when BHPS_Enums.disab_liv_allowcare => mad.current_income( WSC_Enums.disab_liv_allowcare ) := a; -- mad.annual_income( WSC_Enums.disab_liv_allowcare ) := a( 2 );
            when BHPS_Enums.disab_liv_allowmob => mad.current_income( WSC_Enums.disab_liv_allowmob ) := a; -- mad.annual_income( WSC_Enums.disab_liv_allowmob ) := a( 2 );
            when BHPS_Enums.disab_liv_allow_dk => mad.current_income( WSC_Enums.disab_liv_allow_dk ) := a; -- mad.annual_income( WSC_Enums.disab_liv_allow_dk ) := a( 2 );
            when BHPS_Enums.pens_spse_prev_emp => mad.current_income( WSC_Enums.pens_spse_prev_emp ) := a; -- mad.annual_income( WSC_Enums.pens_spse_prev_emp ) := a( 2 );
            when BHPS_Enums.unempl_or_incme_supt => mad.current_income( WSC_Enums.unempl_or_incme_supt ) := a; -- mad.annual_income( WSC_Enums.unempl_or_incme_supt ) := a( 2 );
            when BHPS_Enums.income_support => mad.current_income( WSC_Enums.income_support ) := a; -- mad.annual_income( WSC_Enums.income_support ) := a( 2 );
            when BHPS_Enums.unempl_benefit => mad.current_income( WSC_Enums.unempl_benefit ) := a; -- mad.annual_income( WSC_Enums.unempl_benefit ) := a( 2 );
            when BHPS_Enums.ni_sick_benefit => mad.current_income( WSC_Enums.ni_sick_benefit ) := a; -- mad.annual_income( WSC_Enums.ni_sick_benefit ) := a( 2 );
            when BHPS_Enums.child_benefit => mad.current_income( WSC_Enums.child_benefit ) := a; -- mad.annual_income( WSC_Enums.child_benefit ) := a( 2 );
            when BHPS_Enums.one_parent_benefit => mad.current_income( WSC_Enums.one_parent_benefit ) := a; -- mad.annual_income( WSC_Enums.one_parent_benefit ) := a( 2 );
            when BHPS_Enums.family_credit => mad.current_income( WSC_Enums.family_credit ) := a; -- mad.annual_income( WSC_Enums.family_credit ) := a( 2 );
            when BHPS_Enums.maternity_allow => mad.current_income( WSC_Enums.maternity_allow ) := a; -- mad.annual_income( WSC_Enums.maternity_allow ) := a( 2 );
            when BHPS_Enums.housing_benefit => mad.current_income( WSC_Enums.housing_benefit ) := a; -- mad.annual_income( WSC_Enums.housing_benefit ) := a( 2 );
            when BHPS_Enums.annuity_or_priv_pens => mad.current_income( WSC_Enums.annuity_or_priv_pens ) := a; -- mad.annual_income( WSC_Enums.annuity_or_priv_pens ) := a( 2 );
            when BHPS_Enums.comm_charge_bene => mad.current_income( WSC_Enums.comm_charge_bene ) := a; -- mad.annual_income( WSC_Enums.comm_charge_bene ) := a( 2 );
            when BHPS_Enums.other_state_bene => mad.current_income( WSC_Enums.other_state_bene ) := a; -- mad.annual_income( WSC_Enums.other_state_bene ) := a( 2 );
            when BHPS_Enums.job_seekers_allow => mad.current_income( WSC_Enums.job_seekers_allow ) := a; -- mad.annual_income( WSC_Enums.job_seekers_allow ) := a( 2 );
            when BHPS_Enums.child_tax_credit => mad.current_income( WSC_Enums.child_tax_credit ) := a; -- mad.annual_income( WSC_Enums.child_tax_credit ) := a( 2 );
            when BHPS_Enums.return_to_work_credit => mad.current_income( WSC_Enums.return_to_work_credit ) := a; -- mad.annual_income( WSC_Enums.return_to_work_credit ) := a( 2 );
            when BHPS_Enums.widow_or_war_pens => mad.current_income( WSC_Enums.widow_or_war_pens ) := a; -- mad.annual_income( WSC_Enums.widow_or_war_pens ) := a( 2 );
            when BHPS_Enums.educa_grant => mad.current_income( WSC_Enums.educa_grant ) := a; -- mad.annual_income( WSC_Enums.educa_grant ) := a( 2 );
            when BHPS_Enums.t_u_or_friendly_soc_payt => mad.current_income( WSC_Enums.t_u_or_friendly_soc_payt ) := a; -- mad.annual_income( WSC_Enums.t_u_or_friendly_soc_payt ) := a( 2 );
            when BHPS_Enums.maint_or_alimony => mad.current_income( WSC_Enums.maint_or_alimony ) := a; -- mad.annual_income( WSC_Enums.maint_or_alimony ) := a( 2 );
            when BHPS_Enums.payment_abs_relative => mad.current_income( WSC_Enums.payment_abs_relative ) := a; -- mad.annual_income( WSC_Enums.payment_abs_relative ) := a( 2 );
            when BHPS_Enums.rent_or_boarders_or_lodgers => mad.current_income( WSC_Enums.rent_or_boarders_or_lodgers ) := a; -- mad.annual_income( WSC_Enums.rent_or_boarders_or_lodgers ) := a( 2 );
            when BHPS_Enums.rent_other_prop => mad.current_income( WSC_Enums.rent_other_prop ) := a; -- mad.annual_income( WSC_Enums.rent_other_prop ) := a( 2 );
            when BHPS_Enums.foster_allowance => mad.current_income( WSC_Enums.foster_allowance ) := a; -- mad.annual_income( WSC_Enums.foster_allowance ) := a( 2 );
            when BHPS_Enums.sick_or_acci_insurance => mad.current_income( WSC_Enums.sick_or_acci_insurance ) := a; -- mad.annual_income( WSC_Enums.sick_or_acci_insurance ) := a( 2 );
            when BHPS_Enums.any_other_payment => 
               mad.current_income( WSC_Enums.any_other_payment ) := a;
               -- mad.annual_income( WSC_Enums.any_other_payment ) := a( 2 );
            when BHPS_Enums.wid_mothr_allow => 
               mad.current_income( WSC_Enums.wid_mothr_allow ) := a;
               -- mad.annual_income( WSC_Enums.wid_mothr_allow ) := a( 2 );
            when BHPS_Enums.pension_credit => 
               mad.current_income( WSC_Enums.pension_credit ) := a;
