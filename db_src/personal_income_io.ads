--
-- Created by ada_generator.py on 2012-02-10 02:09:15.584604
-- 
with Wsc_Db_Data;
with DB_Commons;
with Base_Types;
...
package Personal_Income_IO is
   ...
   --
   function Retrieve_By_PK( Username : Unbounded_String; Run_Id : integer; Pid : Big_Integer; Sysno : integer; Iteration : integer; Wave : Unbounded_String; Income_Type : Incomes_Type ) return Wsc_Db_Data.Personal_Income;
   ...
   function Highest_Values_Of( sqlstr : String ) return Wsc_Db_Data.Personal_Income_List.Vector;   
   --
   ...
   procedure Add_Income_Type( c : in out d.Criteria; Income_Type : Incomes_Type; op : d.operation_type:= d.eq; join : d.join_type := d.join_and );
