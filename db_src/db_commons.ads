--
-- Created by ada_generator.py on 2012-02-09 16:45:16.108849
-- 
with Ada.Calendar;
...
package DB_Commons is
   ...
   function To_String( op : Operation_Type ) return String;
   ...
   function Load_Postgres( filename : String; results_file : String ) return Boolean;
