--
-- Created by ada_generator.py on 2012-02-18 22:26:13.071373
-- 
with Wsc_Db_Data;
...
package body Disaggregated_Data_Table_Description_IO is
   ...
   log_trace : GNATColl.Traces.Trace_Handle := GNATColl.Traces.Create( "DISAGGREGATED_DATA_TABLE_DESCRIPTION_IO" );
   ...
   function Retrieve( sqlstr : String ) return Wsc_Db_Data.Disaggregated_Data_Table_Description_List.Vector is
      ...
      Filename_len : aliased SQLLEN := Filename'Size/8;
      Has_Totals_len : aliased SQLLEN := Has_Totals'Size/8;
      Table_Type_len : aliased SQLLEN := Table_Type'Size/8;
      Table_Subtype_len : aliased SQLLEN := Table_Subtype'Size/8;
      Disaggregated_Data_Table_Description : Wsc_Db_Data.Disaggregated_Data_Table_Description;
   begin
