--
-- Created by ada_generator.py on 2012-02-22 07:11:49.449406
-- 
with Wsc_Db_Data;
with DB_Commons;
with Base_Types;
...
package Disaggregated_Data_Table_Cell_IO is
   ...
   --
   procedure Save( Disaggregated_Data_Table_Cell : in out Wsc_Db_Data.Disaggregated_Data_Table_Cell; overwrite : Boolean := True );
